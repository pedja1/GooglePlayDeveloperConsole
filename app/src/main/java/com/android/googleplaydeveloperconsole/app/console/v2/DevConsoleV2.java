...
import com.android.googleplaydeveloperconsole.app.console.DevConsole;
import com.android.googleplaydeveloperconsole.app.console.DevConsoleException;
import com.android.googleplaydeveloperconsole.app.console.NetworkException;
...
public class DevConsoleV2 implements DevConsole
{
    ...
    {
        DevConsoleAuthenticator authenticator = new OauthAccountManagerAuthenticator(accountName,  httpClient);

        return new DevConsoleV2(httpClient, authenticator, new DevConsoleV2Protocol());
    }

    public static DevConsoleV2 createForAccountAndPassword(String accountName, String password, DefaultHttpClient httpClient)
    {
        DevConsoleAuthenticator authenticator = new PasswordAuthenticator(accountName, password, httpClient);

        return new DevConsoleV2(httpClient, authenticator, new DevConsoleV2Protocol());
    }

    private DevConsoleV2(DefaultHttpClient httpClient, DevConsoleAuthenticator authenticator, DevConsoleV2Protocol protocol)
    {
     ...
     * @param activity
     * @return
     * @throws com.android.googleplaydeveloperconsole.app.console.DevConsoleException
     */
    ...
    private List<AppInfo> fetchAppInfos() throws DevConsoleException
    {
        ...
        for (DeveloperConsoleAccount consoleAccount : protocol.getSessionCredentials() .getDeveloperConsoleAccounts())
        {
    ...
    private void fetchRatings(AppInfo appInfo, AppStats stats) throws DevConsoleException
    {
        ...
        String response = post(protocol.createCommentsUrl(developerId), protocol.createFetchRatingsRequest(appInfo.getPackageName()), developerId);
